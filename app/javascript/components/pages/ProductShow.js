  ...
  return (
    <>
      ...
      >
        <CardBody>
          <CardTitle tag="h5">
            {currentProduct.name}, {currentProduct.price}, {currentProduct.cost}
          </CardTitle>
          <CardText>
        ...
        <ListGroup flush>
          <ListGroupItem>Current And Fresh {currentProduct.name}</ListGroupItem>
          <ListGroupItem>
            Market Price: ${currentProduct.price}, Our Wholesale Price: $
            {currentProduct.cost}
          </ListGroupItem>
          <ListGroupItem>
            Please Add To Your Order, The Following Product ID: {currentProduct.id}
          </ListGroupItem>
        </ListGroup>
        <CardBody>
